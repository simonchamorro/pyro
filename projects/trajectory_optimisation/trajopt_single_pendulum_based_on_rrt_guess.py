...
sys.cost_function.Q[0,0] = 0
sys.cost_function.Q[1,1] = 0
sys.cost_function.R[0,0] = 10
sys.cost_function.xbar = np.array([-3.14,0])
...
ub_x0 = [0.0,0] # bounds on inital state
lb_x0 = [0.0,0]


ub_xf = [-3.14,0] #sys.x_ub # bounds on final state
lb_xf = [-3.14,0]
...
result_traj.save('pendulum_rrt_optimised.npy')
